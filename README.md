...
```
cd existing_repo
git remote add origin https://gitlab.com/mohammed.hafsati/icassp_incar_ss.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mohammed.hafsati/icassp_incar_ss/-/settings/integrations)
